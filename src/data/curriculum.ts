...
export const curriculum: Curriculum = {
  ...
  pillars: [
    {
      title: '实修优先',
      body: '师父传授 > 一切文字。每日功课不断，以身体觉受验证义理。',
    },
    {
      title: '义理为地图',
      body: '知见清晰才能不走弯路。读经不为博学，为照见自己在哪里。',
    },
    {
      title: '佛学是利器',
      body: '空性底子让你能更快穿透表层。但先让道教用自己的语言说完。',
    },
  ],
  phases: [
    {
      ...
      title: '立身知命 · 第 1—4 周',
      subtitle:
        '以修行者而非研究者的身份入门。建立正确知见，落实日常功课，清楚自己走上的是一条什么样的路。',
      colorClass: 'p1',
      weeks: [
        {
          id: 'week-1',
    ...
    },
    {
      ...
      title: '法脉深入 · 第 5—9 周',
      subtitle:
        '掌握正一核心法器的神学逻辑。不只学操作，更要懂每一个法器背后的宇宙论依据——它为什么有效。',
      colorClass: 'p2',
      insight:
        '修行者读法的方式：学符箓时问「这道符在宇宙论里代表什么」；学斋醮时问「这个仪式结构如何净化我的业识」；学存思时问「我在观想什么，观想者是谁」——最后这个问题，你的空性底子会让它变得非常锋利。',
      weeks: [
        {
          id: 'week-5-6',
          label: '第 5—6 周',
    ...
    },
    {
      ...
      subtitle:
        '在义理层面贯通正一的解脱论；在修行层面开始建立自己对佛道两家的成熟观察；为长期修行确立方向。',
      colorClass: 'p3',
      insight:
...
export function buildSystemPrompt(focusCardId: string): string {
  ...
  return `你是一位正一派道教的资深修行导师，精通正一派义理、法术、斋醮科仪、符箓、存思等修行体系。你同时理解佛学空性理论，能帮助有佛学基础的道士在两家之间建立深度对话。
